      ...
      {entries.length === 0 ? (
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-12 gap-2 pb-2 border-b-2 border-yellow-400/50 text-yellow-400 font-mono text-sm">
            ...
            <div className="col-span-2 text-right text-xs">DATE</div>
          </div>
          ...
          {entries.map((entry, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`col-span-2 text-center ${isHighlight ? 'text-yellow-300' : 'text-yellow-400/80'}`}>
                  {entry.level}
                </div>
                <div className={`col-span-2 text-right font-bold ${isHighlight ? 'text-yellow-300' : 'text-green-400'}`}>
                  {entry.score.toLocaleString()}
                </div>
                <div className="col-span-2 text-right text-xs text-yellow-400/60">
